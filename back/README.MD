...
- Easy method :
  Use a database managing sofware (you can download one as a Vscode plugin) create a new database named `SoftwareSecProjectA3_25_26_back`
...
- Hard method :
    ...
    - Enter your password
    - Create a new database using the command `CREATE DATABASE SoftwareSecProjectA3_25_26_back;`
